...
from django_analyses.factories.analysis import AnalysisFactory
from django_analyses.factories.input.definitions.boolean_input_definition import (
    BooleanInputDefinitionFactory,
)
from django_analyses.factories.input.definitions.file_input_definition import (
    FileInputDefinitionFactory,
)
from django_analyses.factories.input.definitions.float_input_definition import (
    FloatInputDefinitionFactory,
)
from django_analyses.factories.input.definitions.integer_input_definition import (
    IntegerInputDefinitionFactory,
)
from django_analyses.factories.input.definitions.list_input_definition import (
    ListInputDefinitionFactory,
)
from django_analyses.factories.input.definitions.string_input_definition import (
